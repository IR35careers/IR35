...
const statusStyle: Record<FeedHealthStatus, { label: string; text: string; className: string }> = {
  healthy: { label: "Fresh", text: "Every observed source has refreshed within the last two days.", className: "border-emerald-200 bg-emerald-50 text-emerald-950" },
  mixed: { label: "Mixed freshness", text: "At least one source is fresh while another is delayed or stale.", className: "border-amber-200 bg-amber-50 text-amber-950" },
    ...
    <div className="min-h-screen bg-slate-50 text-slate-950">
      ...
      <main className="ir35-container py-10 sm:py-14">
        ...
        <div className="mt-5 max-w-3xl">
          ...
          <p className="mt-5 text-base leading-7 text-slate-600">A cached, privacy-safe view of active listing counts and the latest time each public source was observed. This reports feed freshness—not whether an individual vacancy is guaranteed open.</p>
        </div>
