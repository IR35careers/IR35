...
import { formatRate, ir35EvidenceLabel, type JobDetail } from "@/lib/job-types";
...
export default function AnalyseExternalJobPage() {
  ...
  return <div className="min-h-screen bg-slate-50"><PublicHeader /><main>
    <header className="border-b border-slate-200 bg-white"><div className="ir35-container py-12 sm:py-16"><div className="max-w-3xl"><p className="text-xs font-bold uppercase tracking-[0.18em] text-brand-700">Bring your own role</p><h1 className="mt-3 text-4xl font-bold tracking-[-0.04em] text-slate-950 sm:text-5xl">Paste a job. Check the evidence. Tailor your CV.</h1><p className="mt-5 text-base leading-7 text-slate-600">Analyse a public HTTPS job page without adding it to the IR35Careers index. We look for structured job data, keep the original source and never treat an absent IR35 statement as Outside.</p></div></div></header>
