    ...
    >
      ...
      <section aria-labelledby="sharing">
        ...
        <ul className="mt-4">
          ...
          <li><strong>Application delivery:</strong> when you choose one-click apply, the exact profile, CV, cover letter and answers you approved are delivered either to the employer&apos;s verified recruitment address or to the configured application service so it can complete the employer form and record the outcome. A connected employer or applicant-tracking system receives the submitted application under its own privacy notice.</li>
