    ...
    >
      ...
      <section aria-labelledby="sharing">
        ...
        <ul className="mt-4">
          ...
          <li><strong>Application delivery:</strong> when you choose one-click apply, the IR35Careers browser runner, the optional IR35Careers Application Assistant in the employer tab, or a verified recruitment connection enters the exact profile, CV, cover letter and answers you approved into the employer portal and records the outcome. The browser assistant receives a one-hour token for one approved application and does not activate on unrelated tabs. The employer, job board and applicant-tracking system receive the submitted application under their own privacy notices.</li>
