    ...
    >
      ...
      <section aria-labelledby="data-we-use">
        ...
        <ul className="mt-4">
          ...
          <li><strong>Optional website analytics:</strong> when you consent, Google Analytics processes page visits, sessions, traffic source, device category and IP-derived approximate country, region and city. We configure analytics without advertising signals and do not send Resume content, application answers or your account identity.</li>
        ...
        <div className="mt-4 overflow-x-auto">
          <table className="w-full min-w-[620px] border-separate border-spacing-0 text-left text-sm">
            ...
            <tbody className="text-slate-600">
              ...
              <tr><td className="border-b border-slate-100 px-3 py-3">Measure website audiences, locations, traffic sources, devices and page use through optional Google Analytics</td><td className="border-b border-slate-100 px-3 py-3">Consent, which can be withdrawn at any time</td></tr>
              <tr><td className="px-3 py-3">Send optional marketing</td><td className="px-3 py-3">Consent, which can be withdrawn</td></tr>
            </tbody>
          </table>
        </div>
      ...
      <section aria-labelledby="sharing">
        ...
        <ul className="mt-4">
          ...
          <li><strong>Google Analytics:</strong> only after you allow analytics. Google processes consented website-use events and approximate location to provide aggregated audience reports. Advertising features and Google signals are disabled in our tag configuration.</li>
