...
export default function JobListingPolicyPage() {
  return (
    <LegalDocument eyebrow="Transparency" title="Job Listing and IR35 Information Policy" summary="How contract opportunities are sourced, cleaned and labelled, and what you should verify before applying." sections={[...sections]}>
      ...
      <section aria-labelledby="apply"><h2 id="apply">Applications, corrections and removals</h2><p className="mt-3">Applications start inside IR35Careers. After your explicit approval, the application runner enters the exact materials you reviewed into supported public employer forms. A role is marked Applied only when the employer page returns a recognisable confirmation. Sign-in, verification, security and unanswered personal questions pause the application for your attention.</p><p className="mt-3">Use <Link href="/contact">Contact</Link> to report an expired role, incorrect status/rate, duplicate, unsafe destination or rights concern. Include the IR35Careers URL and a short explanation so it can be reviewed efficiently.</p></section>
    </LegalDocument>
  );
}
