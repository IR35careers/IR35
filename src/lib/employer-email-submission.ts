...
export async function submitToVerifiedEmployerEmail(input: {
  ...
  const text = [
    ...
    "The candidate reviewed and approved these materials before submission. Their CV is attached as a PDF.",
  ].join("\n");
