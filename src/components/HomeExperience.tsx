...
const WORKFLOW = [
  ...
  { icon: FileCheck2, title: "Understand", body: "Review status evidence, match factors and gaps before investing time.", href: "/jobs/11111111-1111-4111-8111-111111111111" },
  { icon: ClipboardCheck, title: "Prepare", body: "Tailor the CV, draft a grounded letter and approve every screening answer.", href: "/applications/new/11111111-1111-4111-8111-111111111111" },
