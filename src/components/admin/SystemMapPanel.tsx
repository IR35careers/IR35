  ...
  return [
    ...
    },
    {
      id: "apply", number: "03", label: "Apply", summary: "Complete the employer form and retain proof of the result.", nodes: [
        externalNode(integrations, "ats_submission", "Application runner", { icon: ServerCog, description: "Runs a protected Chromium session, maps fields, uploads the approved CV and submits supported forms.", input: "Approved packet and public HTTPS application URL", output: "Employer confirmation or a precise Needs you task", connectsTo: ["Employer portal", "Application tracker"], failure: "CAPTCHA, employer login, verification code, unsupported widget or unanswered required question.", action: integration(integrations, "ats_submission")?.nextStep ?? "Enable the runner." }),
