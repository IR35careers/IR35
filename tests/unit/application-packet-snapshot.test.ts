...
function packet(overrides: Partial<ApplicationRecord> = {}): ApplicationRecord {
  return {
    ...
    missingKeywords: [],
    sourceCvText: "A truthful source CV with sufficient evidence.",
    tailoredCvText: "A truthful tailored CV with sufficient evidence.",
    resumeVersionLabel: "Platform Engineer CV",
