...
| Public Inside and Outside IR35 discovery | P0 | Public landing, `/jobs` search and `/jobs/[id]` detail; IR35, workplace, rate, recency, skills, location, explicit-title seniority, rate basis and positive sponsorship-evidence filters | Implemented | Continue production source-quality and false-positive sampling |
...
| Job alerts | P1 | Owner-scoped saved searches preserve public discovery filters, plus on-demand, cancellable live match previews with loading, empty, error and retry states | Implemented for in-product curation after migration 012 | Delivery provider abstraction, schedule and unsubscribe before claiming email alerts |
